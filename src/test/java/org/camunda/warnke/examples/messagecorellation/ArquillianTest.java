package org.camunda.warnke.examples.messagecorellation;
...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "messagecorellation";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "messagecorellation.war")
            ...
            .addPackages(false, "org.camunda.warnke.examples.messagecorellation") // not recursive to skip package 'nonarquillian'
